<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.examinationName" placeholder="시험명" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
      ...
      <el-row>
        <el-col :span="24">
          ...
          <div class="score">
            ...
            <h4>정답题数: <span type="success">{{temp.correctNumber}}</span></h4>
            <h4>오답题数: <span type="success">{{temp.inCorrectNumber}}</span></h4>
