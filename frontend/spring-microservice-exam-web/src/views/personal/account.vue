        ...
        <el-form ref="form" :rules="rules" :label-position="labelPosition" :model="userInfo" label-width="100px" style="width: 90%;">
          <el-row>
            <el-col :span="12">
              <el-row>
                <el-col :span="24">
                  <el-form-item label="사용자아이디：" prop="identifier">
              ...
              <el-row>
                <el-col :span="24">
                  <el-form-item label="생년월일" prop="born">
                    <el-date-picker v-model="userInfo.born" format="yyyy 년 MM 월 dd 일" value-format="timestamp" placeholder="생년월일"/>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="24">
                  <el-form-item label="전화번호" prop="phone">
                    <el-input v-model="userInfo.phone" placeholder="전화번호"/>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="24">
                  <el-form-item label="이메일" prop="email">
                    <el-input v-model="userInfo.email" placeholder="이메일"/>
                  </el-form-item>
                </el-col>
              </el-row>
            </el-col>
...
export default {
  data () {
    return {
      ...
      disabled: true,
      rules: {
        identifier: [{ required: true, message: '사용자아이디를 입력하세요', trigger: 'change' }]
      },
      headers: {
  ...
  methods: {
    ...
    beforeAvatarUpload (file) {
      ...
      if (!isJPG) {
        this.$message.error('사진은 jpg/png 만 가능합니다!')
      }
      if (!isLt2M) {
        this.$message.error('사진크기는 2MB를 초과하면 안됩니다!')
      }
      return isJPG && isLt2M
    }
  }
