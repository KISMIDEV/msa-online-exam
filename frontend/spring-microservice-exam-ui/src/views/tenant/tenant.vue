          ...
          <el-col :span="20" :offset="2">
            <el-form-item :label="$t('table.tenant.status')" prop="status">
              <el-radio-group v-model="temp.status">
                ...
                <el-radio :label="1">심사통과</el-radio>
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        tenantCode: [{ required: true, message: '파트너코드를 입력하세요', trigger: 'change' }],
        tenantName: [{ required: true, message: '파트너명을 입력하세요', trigger: 'change' }]
      },
