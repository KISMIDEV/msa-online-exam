    ...
    <div class="lock-container">
      <div class="lock-form animated bounceInDown">
        <div class="animated" :class="{'shake':passwdError,'bounceOut':pass}">
          ...
          <el-input placeholder="화면보호비밀번호를 입력하세요" type="password" class="input-with-select animated" v-model="passwd" @keyup.enter.native="handleLogin">
  ...
  methods: {
    ...
    handleLogin () {
      if (this.passwd !== this.lockPasswd) {
        this.passwd = ''
        this.$message({
          message: '화면보호비밀번호오류입니다,다시입력해주세요',
          type: 'error'
        })
