<template>
  <div>
    <el-row :gutter="30">
      <el-col :span="18" :offset="2">
        <el-card class="subject-box-card" v-loading="loading">
          <div class="subject-exam-title" v-if="!loading && tempSubject.id !== ''">{{practice.examinationName}}（모두{{practice.totalSubject}}문제，합계{{practice.totalScore}}점）</div>
    ...
    <el-dialog title="답안지" :visible.sync="dialogVisible" width="50%" top="10vh" center>
      <div class="answer-card-title" >{{practice.examinationName}}（모두{{practice.totalSubject}}문제，합계{{practice.totalScore}}점）</div>
