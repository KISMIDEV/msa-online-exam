<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.courseName" placeholder="과정名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        courseName: [{ required: true, message: '请输入과정名称', trigger: 'change' }]
      },
