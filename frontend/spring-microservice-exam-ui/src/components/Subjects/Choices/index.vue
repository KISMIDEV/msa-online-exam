                ...
                <el-row :gutter="5">
                  ...
                  <el-col :span="21">
                    <el-row :gutter="5">
                      ...
                      <el-col :span="1">
                        <el-button @click.prevent="removeOption(option)">삭제</el-button>
                      </el-col>
                    </el-row>
                  </el-col>
                </el-row>
              </el-form-item>
              <el-button type="success" @click.prevent="addOption()" style="display:block;margin:0 auto">신규선택</el-button>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
    ...
    addOption () {
      ...
      if (this.options.length > 0) {
        ...
        if (!isNotEmpty(option.optionName)) {
          message(this, '신규항목을 선택하세요', 'warning')
          return
        }
