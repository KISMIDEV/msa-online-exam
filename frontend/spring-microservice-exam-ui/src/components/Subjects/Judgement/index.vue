...
export default {
    ...
    subject: {
      ...
      default: function () {
        return {
          ...
          choicesType: 0,
          options: [
            { subjectChoicesId: '', optionName: '정답', optionContent: '정답' },
            { subjectChoicesId: '', optionName: '오답', optionContent: '오답' }
          ],
          answer: {
            subjectId: '',
            answer: '',
  ...
  data () {
    return {
      ...
      // 表单校验规则
      subjectRules: {
        subjectName: [{ required: true, message: '문제제목을 입력하세요', trigger: 'change' }],
        score: [{ required: true, message: '문제점수를 입력하세요', trigger: 'change' }],
        answer: [{ required: true, message: '문제답안을 입력하세요', trigger: 'change' }]
      },
      options: []
    }
  },
  methods: {
    initDefaultOptions () {
      ...
      this.subjectInfo.answer.answer = '정답'
    },
