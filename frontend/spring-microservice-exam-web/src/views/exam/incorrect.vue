      ...
      <el-row>
        <transition name="fade-transform" mode="out-in">
          <el-col :span="20" :offset="2" v-show="!examRecordLoading">
            <el-row>
              <el-col :span="8">
                <label class="el-form-item__label">시험명: {{ examRecordDetail.examinationName }}</label>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <label class="el-form-item__label">정답题数: </label><el-tag type="success" size="small" effect="dark">{{ examRecordDetail.correctNumber }}</el-tag>
              </el-col>
              <el-col :span="8">
                <label class="el-form-item__label">오답题数: </label><el-tag type="danger" size="small" effect="dark">{{ examRecordDetail.inCorrectNumber }}</el-tag>
              </el-col>
            </el-row>
          </el-col>
        </transition>
