package com.github.kingjava.common.security.wx;

import com.github.kingjava.common.security.constant.SecurityConstant;
import com.github.kingjava.common.security.utils.GsonHelper;
...
/**
 * 微信로그인filter，로그인时支持传入用户的资料，如姓名、电话、性别等
 *
 * @author kingjava
...
public class WxAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    /**
     * 微信로그인的code参数，后续用code换取openId和sessionKey
     */
