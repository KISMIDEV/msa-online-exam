        ...
        <el-col :span="24">
          <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
            ...
            <el-form-item prop="code">
              <el-row>
                <el-col :span="14">
                  <el-input :maxlength="code.len" v-model="loginForm.code" size="small" auto-complete="off" placeholder="보안코드를 입력하세요" @keyup.enter.native="handleLogin" />
                </el-col>
                <el-col :span="10">
...
export default {
  ...
  data () {
    return {
      ...
      loginRules: {
        tenantCode: [{ required: true, trigger: 'blur', message: '부서아이디를 입력하세요' }],
        identifier: [{ required: true, trigger: 'blur', message: '아이디를 입력하세요' }],
        credential: [
          { required: true, trigger: 'blur', message: '비밀번호를 입력하세요' },
          { min: 6, trigger: 'blur', message: '비밀번호길이는 최소6자리입니다.' }],
        code: [
