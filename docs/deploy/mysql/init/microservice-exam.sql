...
CREATE TABLE `exam_answer`  (
  ...
  `answer_type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '答题类型，0：정답，1：오답',
...
INSERT INTO `exam_answer` VALUES (691062861052645376, 691062092169613312, 680772677350330368, 2, '정답', 0, 5, 1, '2020-03-21 23:17:01', '2020-03-21 23:20:27', 'anonymousUser', '2020-03-21 23:31:10', 'anonymousUser', '2020-03-21 23:20:27', 0, 'EXAM', 'gitee');
...
INSERT INTO `exam_answer` VALUES (691063227982942208, 691063100123779072, 680772677350330368, 2, '정답', 0, 5, 1, '2020-03-21 23:18:28', '2020-03-21 23:18:33', 'admin', '2020-03-21 23:29:17', 'admin', '2020-03-21 23:18:33', 0, 'EXAM', 'gitee');
...
INSERT INTO `exam_answer` VALUES (696330669739085824, 696330634376908800, 696329277397929984, 2, '정답', 0, 5, 1, '2020-04-05 12:09:27', '2020-04-05 12:10:25', 'student', '2020-04-05 12:21:19', 'student', '2020-04-05 12:10:25', 0, 'EXAM', 'gitee');
...
CREATE TABLE `exam_course`  (
  `id` bigint(20) NOT NULL COMMENT '主键',
  `course_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '과정名称',
  ...
  `course_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '과정描述',
  `creator` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '创建人',
  `create_date` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `modifier` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改人',
  `modify_date` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '과정表' ROW_FORMAT = Compact;
...
CREATE TABLE `exam_examination`  (
  `id` bigint(20) NOT NULL COMMENT '主键',
  `examination_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '시험명',
  ...
  `course_id` bigint(20) NULL DEFAULT NULL COMMENT '과정',
...
CREATE TABLE `exam_examination_record`  (
  ...
  `correct_number` int(11) NULL DEFAULT NULL COMMENT '정답题目数量',
  `incorrect_number` int(11) NULL DEFAULT NULL COMMENT '오답题目数量',
...
CREATE TABLE `exam_subject_category`  (
  ...
  `tenant_code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '문제분류表' ROW_FORMAT = Compact;
...
CREATE TABLE `exam_subject_choices`  (
  ...
  `subject_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '문제명',
...
INSERT INTO `exam_subject_choices` VALUES (696326076057653248, 602231546270846976, '<p>测试判断题2</p>', 0, '정답', 5, '<p>测试判断题2</p>', 2, 'preview', '2020-04-05 11:51:14', 'preview', '2020-04-05 11:51:14', 0, 'EXAM', 'gitee');
...
CREATE TABLE `exam_subject_judgement`  (
  ...
  `subject_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '문제명',
...
-- ----------------------------
INSERT INTO `exam_subject_judgement` VALUES (680772677350330368, NULL, '<p>测试判断题</p>', '정답', 5, '<p>这是解析</p>', 2, 'admin', '2020-04-03 22:49:02', 'preview', '2020-04-03 22:38:06', 0, 'EXAM', 'gitee');
INSERT INTO `exam_subject_judgement` VALUES (696325165767856128, 602231546270846976, '<p>测试判断题</p>', '정답', 5, '<p>测试判断题</p>', 2, 'preview', '2020-04-05 12:01:48', 'preview', '2020-04-05 11:50:58', 0, 'EXAM', 'gitee');
INSERT INTO `exam_subject_judgement` VALUES (696329277397929984, NULL, '<p>判断题</p>', '정답', 5, '<p>A</p>', 2, 'preview', '2020-04-05 12:03:57', 'preview', '2020-04-05 12:03:57', 0, 'EXAM', 'gitee');
