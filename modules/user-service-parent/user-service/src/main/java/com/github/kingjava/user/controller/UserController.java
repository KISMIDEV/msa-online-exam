package com.github.kingjava.user.controller;

import com.github.kingjava.user.api.module.*;
import com.github.pagehelper.PageInfo;
import com.github.kingjava.common.basic.utils.excel.ExcelToolUtil;
...
import com.github.kingjava.user.api.module.*;
import com.github.kingjava.user.excel.listener.UserImportListener;
import com.github.kingjava.user.excel.model.UserExcelModel;
import com.github.kingjava.user.service.DeptService;
import com.github.kingjava.user.service.UserAuthsService;
import com.github.kingjava.user.service.UserRoleService;
...
public class UserController extends BaseController {
     ...
     */
    @GetMapping("info")
    @ApiOperation(value = "获取用户信息", notes = "获取当前로그인用户详细信息")
    ...
    public ResponseBean<UserInfoDto> userInfo(@RequestParam(required = false) String identityType, OAuth2Authentication authentication) {
        try {
            ...
            throw new CommonException("获取当前로그인用户详细信息");
        }
    }
    ...
    @AdminTenantTeacherAuthorization
    @ApiOperation(value = "재설정密码", notes = "根据用户id재설정密码")
    @ApiImplicitParam(name = "userDto", value = "用户实体user", required = true, dataType = "UserDto")
    @Log("재설정密码")
    ...
    @ApiOperation(value = "更新用户로그인信息", notes = "根据用户id更新用户的로그인信息")
    @ApiImplicitParam(name = "userDto", value = "用户实体user", required = true, dataType = "UserDto")
